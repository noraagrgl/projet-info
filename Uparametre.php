...
<head>
    ...
    <link rel="stylesheet" type="text/CSS" href="Uparametre.css">
    <script src="Uparametre.js"></script>
</head>
<body>
    <div id="containerA">
        ...
        <span id="Parametre" class="bouton"> <a href="Uparametre.php">Paramètre</a></span>
    </div>
